...
def main():
    ...
    parser.add_argument("--decoder_layers", "-nl", type=int, default=8, help="Number of layers in the transformer decoder")
    ...
    # Training parameters
    parser.add_argument("--model_path", "-md", type=str, default="./pretrained/model.pt", help="Path to save model")
    parser.add_argument("--device", "-d", type=str, default="cpu", help="Device to use {cpu, cuda:0, cuda:1,...}")
    ...
    # Data parameters
    parser.add_argument("--image_dir", "-id", type=str, default="data/flickr30k/flickr30k_images", help="Path to image directory, this contains train2014, val2014")
    parser.add_argument("--karpathy_json_path", "-kap", type=str, default="data/flickr30k/dataset_flickr30k.json", help="Path to karpathy json file")
